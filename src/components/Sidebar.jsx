...
export default function Sidebar({ collapsed, onToggle }) {
  ...
  const isCitationActive =
    location.pathname.startsWith('/citation');
  ...
  return (
    <aside className="ck-side">
      ...
      <nav className="ck-side-body">
        ...
        <NavLink to="/" className={`ck-nav-item${isAActive ? ' active' : ''}`} end={false}>
          <span className="ck-nav-item-label">출처 검사 A안</span>
          <BadgeBeta />
        </NavLink>

        <NavLink to="/b/list" className={`ck-nav-item${isBActive ? ' active' : ''}`} end={false}>
          <span className="ck-nav-item-label">출처 검사 B안</span>
          <BadgeBeta />
        </NavLink>

        <NavLink to="/c/list" className={`ck-nav-item${isCActive ? ' active' : ''}`} end={false}>
          <span className="ck-nav-item-label">출처 검사 C안</span>
          <BadgeBeta />
        </NavLink>

        <NavLink to="/citation" className={`ck-nav-item${isCitationActive ? ' active' : ''}`} end={false}>
