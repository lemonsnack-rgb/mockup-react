  ...
  return (
    <div className="rl-page">
      ...
      <div className="rl-title-row">
        <h2 className="rl-title">출처 검사 <span className="rl-variant-badge">{variant}</span></h2>
        ...
        <table className="rl-table rl-table-b">
          <thead>
            <tr>
              ...
              <th className="col-style-b">스타일 검사</th>
              <th className="col-validity-b">유효성 검사</th>
                  ...
                  <td className="col-style-b">
                    {row.style === 'skipped' ? (
                      ...
                      <div className="rlb-risk-item style">
                        <span className="rlb-risk-label">위험 수</span>
                  ...
                  <td className="col-validity-b">
                    {row.validity === 'unscanned' ? (
                      ...
                      <div className="rlb-risk-item validity">
                        <span className="rlb-risk-label">미확인</span>
