  ...
  return (
    <div className="rl-page">
      ...
      <div className="rl-title-row">
        <h2 className="rl-title">참고문헌 검증</h2>
        ...
        <table className="rl-table">
          <thead>
            <tr>
              ...
              <th className="col-validity">진위성 검증</th>
              <th className="col-style">적절성 검증</th>
            </tr>
          </thead>
          <tbody>
                ...
                <tr key={row.id}>
                    ...
                    {row.validity === 'unscanned' ? (
                      ...
                      <span className="rl-check-cell">
                        <span className="rl-check-count">
                          미확인(허위의심) <strong>{row.validity.unconfirmed}</strong>건
                        </span>
                        <Link
                          to={`/validity/${row.id}`}
                  ...
                  <td className="col-style">
                    {row.style === 'skipped' ? (
                      ...
                      <span className="rl-check-cell">
                        <span className="rl-check-count">
                          작성오류/품질주의 <strong>{row.style.risk}</strong>건
                        </span>
