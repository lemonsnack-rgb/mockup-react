  ...
  return (
    <div className="vd-page">
      ...
      <div className="vd-header">
        <span className="vd-check-type-badge">진위성 검증</span>
      ...
      <div className="det-summary-card">
        <div className="det-stats-grid">
          <div className="det-stat-card det-stat-card--alert">
          ...
          <div className="det-stat-card">
            <span className="det-stat-label">
              <svg viewBox="0 0 24 24" fill="none" stroke="var(--color-gray-800, #3e4448)" strokeWidth="2.5"><circle cx="12" cy="12" r="10"/><line x1="8" y1="8.5" x2="16" y2="8.5"/><line x1="8" y1="12" x2="16" y2="12"/><line x1="8" y1="15.5" x2="16" y2="15.5"/></svg>
              전체
            </span>
      ...
      <div className="det-verdict-legend">
        ...
        <div className="det-verdict-item registered"><span className="det-verdict-dot" />직접 입력: 미확인 참고문헌 중, 이용자가 유효한 출처로 판단하여 CK 텀즈에 등록 신청한 것으로, 카피킬러가 유효 여부를 확인하거나 보증하지 않음</div>
            ...
            >
              <div className="det-ref-main">
                ...
                <div className="det-ref-content">
                  ...
                  {done ? (
                    <div className="vd-note vd-note--registered">진위성 검증에서 확인되지 않았지만, 이용자가 등록을 신청한 참고문헌입니다.<br />이용자가 등록한 참고문헌은 카피킬러가 유효 여부를 확인하거나 보증하지 않습니다.</div>
                  ) : r.note ? (
