...
export const VALID = [
  ...
  {id:19,v:'unconfirmed',t:'paper',tl:'논문',
   ...
   conf:0.72,
   fc:{제목:'check',저자:'check',발행처:'check',발행연도:'check'}},
  ...
  {id:20,v:'unconfirmed',t:'paper',tl:'논문',
   ...
   conf:0.68,
   fc:{제목:'check',저자:'match',발행처:'match',발행연도:'match'}},
  ...
  {id:21,v:'unconfirmed',t:'paper',tl:'논문',
   ...
   conf:0.61,
   fc:{제목:'check',저자:'check',발행처:'match',발행연도:'match'}},
  ...
  {id:22,v:'unconfirmed',t:'paper',tl:'논문',
   ...
   conf:0.75,
   fc:{제목:'check',저자:'match',발행처:'check',발행연도:'match'}},
  ...
  {id:24,v:'unconfirmed',t:'thesis',tl:'논문',
   ...
   m:{AUT:'주예린',TIT:'공공도서관 50+ 금융 리터러시 프로그램 개발에 관한 연구',PUB:'이화여자대학교',DAT:'2019'},conf:0.15,
   fc:{제목:'check',저자:'check',발행처:'check',발행연도:'check'}},

  /* ── 보고서 ── */
  {id:25,v:'partial',t:'report',tl:'보고서',
  ...
  {id:26,v:'unconfirmed',t:'paper',tl:'논문',
   ...
   m:{AUT:'정현선',TIT:'성찰적 문화교육으로서의 미디어 리터러시 교육',JOU:'국어교육학연구',DAT:'2002',VOL:'14, 387-408'},conf:0.12,
   fc:{제목:'check',저자:'check',발행처:'check',발행연도:'check'}},

  {id:27,v:'unconfirmed',t:'paper',tl:'논문',
   c:'이병기 (2006). 정보활동 중심의 도서관활용수업 모형에 관한 연구. 한국도서관·정보학회지, 37(2), 25-46.',
   m:{AUT:'이병기',TIT:'정보활동 중심의 도서관활용수업 모형에 관한 연구',JOU:'한국도서관·정보학회지',DAT:'2006',VOL:'37(2), 25-46'},conf:0.08,
   fc:{제목:'check',저자:'check',발행처:'check',발행연도:'check'}},

  {id:28,v:'unconfirmed',t:'paper',tl:'논문',
   c:'이정연 (2007). 학교도서관과 정보활용교육의 효용성에 관한 연구. 한국도서관·정보학회지, 38(4), 67-85.',
   m:{AUT:'이정연',TIT:'학교도서관과 정보활용교육의 효용성에 관한 연구',JOU:'한국도서관·정보학회지',DAT:'2007',VOL:'38(4), 67-85'},conf:0.10,
   fc:{제목:'check',저자:'check',발행처:'check',발행연도:'check'}},
  ...
  {id:32,v:'unconfirmed',src:'online',t:'paper',tl:'논문',
   ...
   url:'https://www.unesco.org/webworld/infolit',conf:0,
   fc:{제목:'check',저자:'check',발행처:'check',발행연도:'check'}},

  {id:33,v:'partial',src:'online',t:'paper',tl:'논문',
  ...
  {id:34,v:'partial',src:'online',t:'paper',tl:'논문',
...
export const VL = { confirmed: '확인', unconfirmed: '미확인', partial: '부분 확인', registered: '직접 입력' };
export const VC = { confirmed: 'exact', unconfirmed: 'mismatch', partial: 'partial', registered: 'registered' };
