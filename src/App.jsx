...
import UploadC from './pages/UploadC'
import AdminValidityList from './pages/AdminValidityList'
import GptKillerResult from './pages/GptKillerResult'
import './App.css'
    ...
    <div className={`app-wrap${collapsed ? ' collapsed' : ''}`}>
      ...
      <main className="app-main">
        <Routes>
          ...
          <Route path="/c/upload" element={<UploadC />} />
          <Route path="/c/admin/list" element={<AdminValidityList />} />
          {/* GPT킬러 검사결과 배너 시안 */}
          <Route path="/gk/result" element={<GptKillerResult />} />
        </Routes>
      </main>
    </div>
  )
